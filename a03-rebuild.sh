...
# backup old .apk
cp /workspace/my-gitpod-flutter/public/$wow4-app-debug.apk /workspace/my-gitpod-flutter/public/$wow4-backup-app-debug.apk
...
echo "<li> Next rebuild <a href="$wow4-app-debug.apk">$wow4-app-debug.apk</a><br>" >> /workspace/my-gitpod-flutter/public/index.html
